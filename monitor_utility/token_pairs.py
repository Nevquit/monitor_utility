...
class TokenPairsUtility:
    ...
    def __init__(self,net,iWAN_Config,chainInfo:dict,crossPoolTokenInfo:dict,evmChainCrossSc:dict,print_flag=False):
        ...
        :param net: 'main'/'test'
        :param chainInfo
        :param crossPoolTokenInfo
        :param evmChainCrossSc
    ...
    def get_xrp_token_pairs(self):
        ...
        tokenPairs_all = self.get_token_pairs()['result']
    ...
    def get_chain_dict(self):
        ...
        return chainIdDict, chainAbbr, noEVMChains
    def get_pool_token_dict(self):
        poolTokenDict = {}
        poolTokenInfo = self.get_pool_token_info()
            ...
            '''
                    {
                        "id": "252",
                        "fromChainID": "2147483708",
                        "fromAccount": "0x495f947276749ce646f68ac8c248420045cb7b5e",
                        "toChainID": "2147484614",
                        "toAccount": "0x990825c5d894385f1c5bd36b6427c5336d984e07",
                        "ancestorSymbol": "OPENSEA",
                        "ancestorDecimals": "0",
                        "ancestorAccount": "0x495f947276749ce646f68ac8c248420045cb7b5e",
                        "ancestorName": "OPENSEA",
                        "ancestorChainID": "2147483708",
                        "fromName": "OPENSEA",
                        "fromSymbol": "OPENSEA",
                        "name": "OPENSEA",
                        "symbol": "OPENSEA",
                        "fromDecimals": "0",
                        "fromAccountType": "Erc1155",
                        "fromAccountIsLayer2": false,
                        "toAccountType": "Erc1155",
                        "toAccountIsLayer2": false
                    }
            '''
