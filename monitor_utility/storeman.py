...
class StoremanUtility:
    ...
    def pprint(self,*args,**kwargs):
        if self.print_flag :
            print(*args,**kwargs)
    def get_working_groups_ids(self):
        '''
    ...
    def get_working_groups_details(self):
        '''
    ...
    def get_storeman_candidates(self):
        '''
        ...
        return Candidates
    def get_not_ready_storeman_grs(self):
        '''
                0：none,
            1：initial,
            2：curveSeted,
    ...
    def get_candidates_per_gr(self, grID):
        '''
        :param iwan:
        :param grID:
        ...
        return Candidates
    def get_group_status(self,statusID):
...
if __name__ == '__main__':
    ...
    print(utl.get_working_groups_ids())